...
import com.example.spring_boot_essentials.service.AvaliacaoFisicaService;
...
public class AvaliacoesFisicasController {
    ...
    public void criarAvaliacaoFisica(@Valid @RequestBody AvaliacaoFisicaDto avaliacaoFisicaDto) throws BadRequestException, NotFoundException {
